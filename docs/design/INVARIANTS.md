...
| `test_harness_helper_modules_only_emit_allowlisted_event_kinds` | orchestration helpers may emit only allowlisted telemetry / artifact-completion events; state-transition events stay in Orchestrator | INVARIANTS §0 |
