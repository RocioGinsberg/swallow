...
最近一次 triage：2026-05-04(post-LTO-2 merge)。结论:LTO-1 stage 2 source-anchor cross-candidate evidence dedup Roadmap-Bound 项已由 LTO-2 消化,移到 Resolved。`know_evidence` 物理 schema migration / task-scoped `knowledge_evidence` mismatch 仍为 Active Open/deferred。前两轮 triage:2026-05-04(Hygiene Bundle),2026-05-04(post-v1.8.0 + LTO-1 closeout)。
