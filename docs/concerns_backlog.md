...
| 59 | tag-level release docs sync debt | v1.5.0 release docs | README release snapshot was refreshed to `v1.5.0`; `current_state.md` and `docs/active_context.md` now track the pending release tag. `AGENTS.md` remains coordination-only and no longer carries release snapshot state |
