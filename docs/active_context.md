...
1. 先补 inspect / control 对 remote candidate readiness 的可见面
2. 再把 remote handoff guidance 接到 review / summary 等 operator-facing snapshot
3. 最后同步 README / closeout 边界说明
