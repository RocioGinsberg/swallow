...
1. 先把 remote handoff contract 接入 execution-site / dispatch / handoff 的 operator-facing report surface
2. 再补 inspect / control 对 remote candidate readiness 的可见面
3. 最后同步 CLI help / README 的命名与边界说明
