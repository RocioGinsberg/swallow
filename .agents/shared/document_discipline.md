...
| `design-auditor` | `docs/plans/<phase>/plan_audit.md` | 不写 active_context、不改 plan.md 正文 |
| `consistency-checker` | `docs/plans/<phase>/consistency_report.md` | 不修改设计文档、不修改实现代码 |
| `concern-logger` | `docs/concerns_backlog.md` | 不改 review_comments、不写 active_context |
...
| `docs(plan)` | `docs(plan): add Phase 60 plan` | phase plan 文档(plan / plan_audit / closeout 等) |
...
Reading manifest:
  ...
  ⚠ docs/plans/Phase60/plan.md (not found, will be authored this session)
Ready to: produce plan.md
```
