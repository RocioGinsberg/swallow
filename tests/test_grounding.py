        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            state = TaskState(
                ...
                artifact_paths={
                    ...
                    "remote_handoff_contract_json": str((tmp_path / ".swl" / "tasks" / task_id / "remote_handoff_contract.json").resolve()),
                    ...
                    "execution_budget_policy_json": str((tmp_path / ".swl" / "tasks" / task_id / "execution_budget_policy.json").resolve()),
