...
class WebApiPayloadsTest(unittest.TestCase):
    def test_control_center_static_index_contains_dashboard_sections(self) -> None:
        ...
        self.assertIn("id=\"operator-actions-panel\"", payload)
        self.assertIn("id=\"task-create-form\"", payload)
        self.assertIn("id=\"knowledge-review-form\"", payload)
        self.assertIn("id=\"proposal-review-form\"", payload)
        self.assertIn("id=\"knowledge-surface\"", payload)
        self.assertIn("id=\"wiki-authoring-panel\"", payload)
        self.assertIn("id=\"wiki-authoring-form\"", payload)
        self.assertIn("id=\"wiki-authoring-mode\"", payload)
        self.assertIn("id=\"wiki-job-list\"", payload)
        self.assertIn("id=\"wiki-prefill-selected-button\"", payload)
        self.assertIn("id=\"knowledge-kind-select\"", payload)
        self.assertIn("id=\"knowledge-status-select\"", payload)
        self.assertIn("id=\"knowledge-list\"", payload)
        self.assertIn("id=\"knowledge-detail-meta\"", payload)
        self.assertIn("id=\"knowledge-relation-list\"", payload)
        self.assertIn("id=\"knowledge-text\"", payload)
        self.assertIn("id=\"knowledge-candidate-review-block\"", payload)
        self.assertIn("id=\"knowledge-confirm-supersede\"", payload)
        self.assertIn("id=\"knowledge-confirm-conflict\"", payload)
        self.assertIn("id=\"knowledge-detail-promote-button\"", payload)
        self.assertIn("id=\"knowledge-detail-reject-button\"", payload)
        self.assertIn("/api/tasks?focus=", payload)
        self.assertIn("/api/knowledge/${kind}?status=${status}", payload)
        self.assertIn("/api/knowledge/${encodedObjectId}", payload)
        self.assertIn("/api/knowledge/${encodedObjectId}/relations", payload)
        self.assertIn('path: "/api/wiki/draft"', payload)
        self.assertIn('path: "/api/wiki/refine"', payload)
        self.assertIn('path: "/api/wiki/refresh-evidence"', payload)
        self.assertIn("/api/wiki/jobs/${encodeURIComponent(job.job_id)}", payload)
        ...
        self.assertIn("/api/knowledge/staged/${encodeURIComponent(candidateId)}/promote", payload)
        self.assertIn("/api/knowledge/staged/${encodeURIComponent(candidateId)}/reject", payload)
        self.assertIn("confirmed_notice_types", payload)
        self.assertIn("confirmed_supersede_target_ids", payload)
        self.assertIn("confirmed_conflict_flags", payload)
        self.assertIn('postJson("/api/proposals/review"', payload)
        self.assertIn('postJson("/api/proposals/apply"', payload)
    ...
    def test_create_fastapi_app_exposes_root_dashboard_when_optional_dependency_is_available(self) -> None:
        ...
        self.assertIn("/api/tasks/{task_id}/run", route_paths)
        self.assertIn("/api/tasks/{task_id}/retry", route_paths)
